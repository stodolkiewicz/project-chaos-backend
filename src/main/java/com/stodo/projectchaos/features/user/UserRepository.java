...
public interface UserRepository extends JpaRepository<UserEntity, UUID> {
    ...
    @Query("SELECT new com.stodo.projectchaos.features.user.dto.query.ProjectUserQueryResponseDTO(" +
            "u.id, u.email, u.firstName, u.lastName, CAST(pu.projectRole AS string), u.googlePictureLink, pu.createdDate) " +
           "FROM UserEntity u " +
